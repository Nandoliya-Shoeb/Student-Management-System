...
class Student(models.Model):
    ...
    phone = models.CharField(max_length=15, blank=True, null=True, default='', verbose_name=_('Phone'))
    photo = models.ImageField(upload_to='student_photos/', null=True, blank=True, verbose_name=_('Photo'))
    class_field = models.CharField(max_length=1, choices=CLASS_CHOICES, default='8', verbose_name=_('Class'))
    address = models.TextField(blank=True, default='', verbose_name=_('Address'))
    joining_date = models.DateField(null=True, blank=True, verbose_name=_('Joining Date'))
